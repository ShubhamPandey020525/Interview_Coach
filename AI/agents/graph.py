...
from AI.agents.followup_agent import followup_node
from AI.agents.learning_agent import learning_node
from AI.agents.orchestrator import orchestrator_node
from AI.agents.personality_agent import personality_node
from AI.agents.resume_agent import resume_node
from AI.agents.scenario_agent import scenario_node
from AI.agents.state import InterviewState
from AI.agents.technical_agent import technical_node
from AI.services.llm_provider import LLMProvider, get_llm_provider
...
class InterviewGraph:
    ...
    async def submit_answer(self, session_id: str, answer: str) -> dict:
        ...
        updates = {
            ...
            + [{"type": "technical" if agent_type in ("technical", "followup") else ("communication" if agent_type == "scenario" else "personality"), "score": eval_result.score}],
        }
